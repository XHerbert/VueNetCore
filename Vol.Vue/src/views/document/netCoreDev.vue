  ...
  <div class="doc">
    ...
    <div class="doc-right">
      ...
      <div class="top-content">
        <div>
          <p class="desc">
            后台开发都是代码生成器生成后的类进行扩展及常用功能使用
          </p>
        </div>
        <div>
          <p class="desc" style="font-size: 20px">
            后台完整扩展实现：VOL.Order->Services->Sell->Partial->SellOrderService.cs文件
          </p>
        </div>
      </div>
      <Alert type="success" show-icon>
        ...
        <template slot="desc">
          <div style="line-height: 2">
            <p>
              每个表由代码生成器生后的文件名都包括表名,直接在vs中搜索表名就可以看到所有生成相关表的文件
            </p>
            <p>所有自定义接口与业务实现都统一在Partial文件夹下实现</p>
            <p>
              表xxRepository.Instance用于调用仓储方法，如SellOrderRepository.Instance
            </p>
            <p>
              表xxService.Instance用于调用或编写业务，如SellOrderService.Instance，建议接口注入IxxService
            </p>
          </div>
        </template>
      </Alert>
      ...
      <Alert type="success" show-icon>
        ...
        <template slot="desc">
          <p style="color: red; font-size: 16px">
            多租户2020.08.15更新，只需要更新后台文件：ServiceBase.cs、ServiceFunFilter.cs
          </p>
        </template>
      </Alert>
      <el-collapse v-model="activeName" accordion>
        ...
        >
          ...
          <div>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <span style="color: #6a9955"
              >//开启多租户功能,开启后会对查询、导出、删除、编辑功能同时生效</span
            >
          </div>
          <div>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div style="padding: 10px 0; font-size: 22px; color: red">
          多租户不能直接使用，请在ServiceBase.cs中统一修改CheckUpdateMultiTenancy、CheckDelMultiTenancy、GetSearchQueryable方法，具体修改请看方法的描述
        </div>
      </el-collapse>
    </Drawer>
  </div>
