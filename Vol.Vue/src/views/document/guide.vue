<template>
  <div class="doc-content">
    ...
    <div class="g-right" style="margin-left: 140px">
      ...
      <a
        target="_blank"
        style="border-bottom: 1px solid; margin: 0px 26px; font-size: 26px"
        href="http://donate.volcore.xyz"
        >项目赞助</a
      >
      <a style="border-bottom: 1px solid; margin: 0px 26px; font-size: 26px"
        >QQ群:45221949</a
      >
      <h2
      ...
      >
        <li>
          <span style="line-height: 3; font-size: 16px"
            ...
            、EFCore3.1、JWT、Dapper、Autofac、SqlServer/MySql/PGSql、Redis(可选)</span
          >
        </li>
        <li>
          <span style="line-height: 3; font-size: 16px"
      ...
      >
        <li style="padding-left: 26px; list-style: none">
          <span style="color: #e56600"
            >运行前先看后台appsettings.json配置属性说明</span
          >
        </li>
        <li
          style="
        ...
        >
          <span style="line-height: 3; font-size: 14px; color: red">
            <span style="font-size: 16px"
              >1、登录页面一直登录中不跳转：数据库连接没配置好,在appsettings.json中重新配置，或者可以调试查看具体错误，后台调试方法见文档：【后台开发】->【调试】</span
            >
          </span>
        </li>
        <li
        ...
        >
          <span style="line-height: 3; font-size: 14px; color: red">
            <span style="font-size: 16px"
              >2、登录页面【网络出了点问题】：检查浏览器控制台是否有异常输出跨域问题；数据库连接没配置，见上面第一步</span
            >
          </span>
        </li>
        <li
        ...
        >
          <span style="line-height: 3; font-size: 14px; color: red">
            <span style="font-size: 16px"
              >4、项目启动报错：点击登录提示网络出错(如果是mysql数据库，请确认appsettings.json配置中DBType是否改为了MySql)</span
            >
          </span>
        </li>
        <li
