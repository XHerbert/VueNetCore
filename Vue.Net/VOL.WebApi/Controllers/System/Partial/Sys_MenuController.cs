...
namespace VOL.System.Controllers
{
    public partial class Sys_MenuController
    {
        ...
        //只有角色ID为1的才能进行保存操作
        [HttpPost, Route("save"), ApiActionPermission(ActionRolePermission.SuperAdmin | ActionRolePermission.SystemAdmin)]
        ...
        /// <returns></returns>
        [ApiActionPermission(ActionRolePermission.SuperAdmin | ActionRolePermission.SystemAdmin)]
