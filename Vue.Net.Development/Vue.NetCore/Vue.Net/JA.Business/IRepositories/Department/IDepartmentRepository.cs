 ...
 *Repository提供数据库操作，如果要增加数据库操作请在当前目录下Partial文件夹IDepartmentRepository编写接口
 */
using System;
...
{
    public partial interface IDepartmentRepository : IDependency,IRepository<Department>
    {
    }
    }
