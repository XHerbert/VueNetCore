    ...
    var vueParam = {
        ...
        data() {
            return {
                ...
                searchFormOptions: [[{"title":"帐号","field":"UserName"},{"dataKey":"gender","title":"性别","field":"Gender","type":"drop"},{"title":"真实姓名","field":"UserTrueName"}],[{"title":"部门","field":"DeptName"},{"dataKey":"roles","title":"角色","field":"Role_Id","type":"drop"},{"title":"Token","field":"Token"}],[{"dataKey":"ut","title":"登录设备类型","field":"AppType","type":"dropList"},{"dataKey":"isphone","title":"手机用户","field":"IsRegregisterPhone","type":"drop"},{"title":"手机号","field":"PhoneNo"}],[{"dataKey":"enable","title":"是否可用","field":"Enable","type":"drop"},{"title":"地址","field":"Address"},{"title":"Email","field":"Email"}],[{"title":"注册时间","field":"CreateDate","type":"datetime"},{"title":"最后登录时间","field":"LastLoginDate","type":"datetime"}]],
                columns: [{field:'UserName',title:'帐号',type:'string',link:true,width:120,readonly:true,require:true,align:'left',sortable:true},
                       ...
                       {field:'AppType',title:'登录设备类型',type:'int',bind:{ key:'ut',data:[]},width:150,hidden:true,align:'left'},
                       ...
                       {field:'LastLoginDate',title:'最后登录时间',type:'datetime',width:150,hidden:true,align:'left',sortable:true},
